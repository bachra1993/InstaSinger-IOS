...
class FollowingViewController: UIViewController , UITableViewDelegate , UITableViewDataSource {
   ...
   var user:String?
    ...
    override func viewDidLoad() {
        ...
        ref.child("following").child(self.user!).queryOrdered(byChild: "fullname").observe(.childAdded, with: { (snapshot) in
            print("data returnd")
            print(snapshot)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let FollowingCell:UITableViewCell = tableView.dequeueReusableCell(withIdentifier: "FollowingCell")!
